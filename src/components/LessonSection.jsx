...
export function LessonSection({ section, index, lesson, onZoom }) {
  ...
  return <section id={'section-' + index} tabIndex={-1} className="article-section prose-section">
    ...
    {section.screenshot ? <div className="lesson-visual-step">{instructions}<TutorialImage screenshot={section.screenshot} showNotes={!section.actionSteps}/></div> : instructions}
    ...
    {section.prompt && <PromptBlock text={section.prompt} label={section.promptLabel}/>}
