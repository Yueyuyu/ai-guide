...
export function Shell({ route, children }) {
  ...
  return <>
    ...
    <footer className="site-footer"><span>先学会使用，再慢慢深入。</span><nav aria-label="页尾导航"><a href="#/tutorials">全部教程</a><a href="#/projects">实战项目</a><a href="#/library">我的学习</a><a href="#/about">关于与来源</a></nav><a href="#/">AIGuide</a></footer>
