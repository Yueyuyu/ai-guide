...
export const paths = [
  ...
  { id: 'builder', title: '用 AI 做出第一个网站', subtitle: '在同一套 Codex 工作环境中，从需求走到修改与验收。', audience: '适合已具备服务访问与账号条件的你', icon: 'code', color: 'peach', sequence: ['choose-model', 'codex-web', 'codex-iterate', 'website-check'], outcome: '完成一个本地网页，保存运行说明与验收记录。', preparation: '准备电脑、可用的官方服务与账号、当前系统支持的桌面应用和独立练习文件夹。概念课与参考作品可直接阅读。', electives: ['cursor-debug', 'codex-cloud-start', 'codex-cli-start'], projectId: 'personal-page' },
