...
export const doubaoNotice = {
  ...
  sections: [
    ...
    {
      title: '准备一份能逐项核对的通知',
      paragraphs: ['这是一段本站编写的虚构通知，不涉及真实活动或个人资料。先读一遍，留意两处故意没有确定的信息：活动地点和主持人。', '点击“复制”可以复制材料；也可以下载 TXT 留作原文。下一步的完整提示词已经包含这份通知，不必上传文件。'],
    ...
    },
    {
      ...
      links: [{ label: '选学：豆包桌面工作模式', href: '#/learn/doubao-work-start' }],
    },
  ],
