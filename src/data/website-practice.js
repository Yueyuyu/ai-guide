...
export const codexPractice = {
  ...
  description: '用一份完整需求单，创建无需安装依赖、能在本地打开的个人主页。', edited: '2026-09-16',
  ...
  sections: [
    {
      ...
      "paragraphs": [
        "官网和账号已可用就继续；打不开时，先完成下方网络准备。"
      ],
      "actionSteps": [
        "在“文档”中新建空目录 AIGuide-practice/personal-page。",
        "从官方入口安装并登录 ChatGPT 桌面版，打开这个目录。",
        "选择 Codex → New chat（新建聊天），先发送下方只读检查。"
      ],
      "links": [
        {
    ...
    },
    {
      "title": "先看要做出什么",
      "paragraphs": [
        "先看下方参考作品：只包含简介、项目和联系说明。它是本站人工示例，不是你的生成结果。"
      ],
      "downloads": [
        {
      ...
      "links": [
        {
          "href": "practice/personal-page-reference.html",
          "label": "打开参考作品（新标签页）",
          "external": true
        }
      ],
    ...
    {
      "title": "打开实际文件，核对三个板块",
      "paragraphs": ["这一步要在浏览器中看到你实际生成的网页。"],
      "actionSteps": [
        "在练习目录找到 index.html，右键选择浏览器打开。",
        "依次点“简介”“项目”“联系”，确认跳到对应内容。",
        "缩窄窗口检查文字，记录还没检查的地方。"
      ],
      "checkpoint": "自己在浏览器看到了实际网页，三个板块和导航可逐项核对。",
      "faq": [
        [
          "出现命令请求，该怎么办？",
      ...
      "visual": {
        ...
        "items": [
          {
            "title": "还未完成",
            "text": "聊天中只有代码，或文件叫 index.html.txt"
          },
          {
            "title": "可以继续",
            "text": "实际 HTML 已打开，三处导航能使用"
          }
        ],
        "kind": "compare",
        "label": "核对示例 · 非产品实测"
...
export const websiteLessons = [
  {
    id: 'codex-iterate', productId: 'codex', platform: 'desktop', lessonType: 'operation', title: '继续用 ChatGPT，完成一次明确修改', description: '在同一个网页上提出小范围改动，查看文件差异并复查。', category: 'coding', level: '入门', minutes: 25, tools: ['codex'], color: 'peach', cover: ['让网页再好一点', '说清范围，检查差异'], edited: '2026-09-16',
    ...
    sections: [
      ...
      {
      "title": "查看差异并重新打开页面",
      "paragraphs": ["先核对修改范围，再看页面是否符合要求。"],
      "actionSteps": [
        "查看文件差异，确认只有标签和相关样式变化。",
        "刷新同一路径的 index.html，逐一核对三个标签。",
        "缩窄窗口，再点击导航检查位置。"
      ],
      "visual": {
        "title": "这一轮检查什么",
  ...
  {
    id: 'website-check', title: '把网页从“能打开”检查到“能使用”', description: '按桌面、手机、键盘与内容清单验收，保存自己的交付记录。', category: 'coding', lessonType: 'project', platform: 'general', level: '入门', minutes: 25, tools: ['codex', 'cursor'], color: 'sage', cover: ['完成第一个作品', '逐项核对，再交付'], edited: '2026-09-16',
    ...
    sections: [
      ...
      "visual": {
        ...
        "items": [
          {
            "title": "宽屏",
            "text": "内容完整、导航可用、文字放大可读"
          },
          {
            "title": "窄屏",
            "text": "无需左右拖动，没有卡片遮挡或标签溢出"
          }
        ],
        "kind": "compare",
        "label": "核对示例 · 非产品实测"
